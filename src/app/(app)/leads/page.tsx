    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="bg-[var(--surface)] px-6 pt-4 pb-3 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/leads/new"
            className="flex items-center gap-2 rounded-lg border border-[var(--border)] bg-white px-3 py-1.5 text-sm font-medium text-[var(--txt)] hover:bg-[var(--inp-bg)] transition-colors"
          >
            <Plus className="h-4 w-4" />
            New Lead
          </Link>
          <span className="text-xs text-[var(--muted)] ml-auto">{totalCount} results</span>
        </div>
      </div>
