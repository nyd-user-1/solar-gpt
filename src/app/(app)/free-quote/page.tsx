...
import { ArrowLeft, ArrowRight, Bell, CheckCircle, X, ArrowUp, Sun, MapPin } from 'lucide-react'
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="min-h-full flex flex-col justify-center px-4 py-6">
          ...
          <div className={`mx-auto w-full max-w-3xl min-h-[400px] transition-opacity duration-150 ${animating ? 'opacity-0' : 'opacity-100'}`}>
            ...
            {currentStep === 'address' && (
              <div>
                <div className="mb-4 inline-flex items-center gap-1 rounded-lg px-3 py-1.5 text-sm text-gray-400">
                  Get Started
